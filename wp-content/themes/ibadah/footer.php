<footer style="background-image: url(assets/img/footer-img.jpg);">
            ...
            <div class="row Information pb-0">
                <div class="col-lg-4 col-md-6">
                    <div class="widget-title">
                        <h3>Information</h3>
                        <p>Lorem ipsum, or lipsum as it is some times known, is dummy text used in laying out pri nt,
                            graphic or web lirm Lorem ipsum, or lip designs.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
    ...
    <script src="<?php echo get_template_directory_uri();?>/assets/js/circle-progres.js"></script>
    <!-- fancybox -->
    <script src="<?php echo get_template_directory_uri();?>/assets/js/jquery.fancybox.min.js"></script>
    <script src="<?php echo get_template_directory_uri();?>/assets/js/audioplayer.js"></script>
    <script>
        $(function () {
            $('audio').audioPlayer();
        });
